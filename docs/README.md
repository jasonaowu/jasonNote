...
## ✨ 初衷
Fork LearnData 开源方案，搭建个人知识库，希望用体系化的方法，记录学习笔记，方便自己查阅。

基于 VuePress 和 vuepress-theme-hope 构建了 LearnData 开源笔记，将我所有的笔记与文章聚合到同一页面形成知识库，便于集中管理和分享。
...
- 机器学习：记录机器学习相关知识、算法、框架、工具等；
- 深度学习：记录深度学习相关知识、算法、框架、工具等；
- 计算机视觉：记录计算机视觉相关知识、算法、框架、工具等；
- 大模型：前沿知识学习；
- 代码编程：常用代码的学习和使用笔记，源码阅读记录；
- 生活角落：说明书、生活记录和小技巧；
